    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add categorymenu</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-12">
              <div class="card top-selling overflow-auto">
                <div class="card-body pb-0">
                      ...
                      <form action="{{route('save_categorymenu')}}" method="POST">
                          @csrf
                          <table class="table table-bordered table-hover">
                            <tr>
                                <th width="10%">Category Name</th>
                                <td width="90%"><input type="text" name="category_name" id="category_name">
                                  @error('category_name')
