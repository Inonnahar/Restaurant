            ...
            <div class="col-12">
              <div class="card top-selling overflow-auto">
                <div class="card-body pb-0">
                      <a href="{{route('aboutindex')}}" class="btn btn-md " style="width:12%; background:#547258; color:white; margin-bottom: 15px;"><i class="fas fa-arrow-left" style="color:white"></i>&nbsp;&nbsp;Back</a>
                        <form action="{{route('save_about')}}" method="POST" enctype="multipart/form-data">
                        ...
                        @csrf
                          ...
                          <tr>
                            ...
                            <tr>
                                ...
                                <td width="90%"><input type="file" name="video_photo" id="video_photo">
                                  @error('video_photo')
                                  <span style="color:red">{{$message}}</span>
                                  @enderror
                                </td>
