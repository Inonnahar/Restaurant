            ...
            <div class="container">
              <div class="row justify-content-between gy-5">
                <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
                  <h2 data-aos="fade-up">{{$l->title}}</h2>
                  <p data-aos="fade-up" data-aos-delay="100">{{$l->description}}</p>
                  <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
                    <a href="{{ route('booktable')}}" class="btn-book-a-table">Book a Table</a>
                    <a href="https://www.youtube.com/watch?v=LXb3EKWsInQ" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
                  </div>
                </div>
                <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
                  <img src="{{asset('uploads/'.$l->image)}}" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="300">
                </div>
              </div>
            </div>
      ...
      <div class="tab-pane fade active show" id="menu-starters">
        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-4 menu-item">
            <a href="{{url('front/assets/img/menu/menu-item-1.png')}}" class="glightbox"><img src="{{url('front/assets/img/menu/menu-item-1.png')}}" class="menu-img img-fluid" alt=""></a>
            <h4>Magnam Tiste</h4>
            <p class="ingredients">
          ...
          <div class="col-lg-4 menu-item">
            <a href="{{url('front/assets/img/menu/menu-item-2.png')}}" class="glightbox"><img src="{{url('front/assets/img/menu/menu-item-2.png')}}" class="menu-img img-fluid" alt=""></a>
            <h4>Aut Luia</h4>
            <p class="ingredients">
              Lorem, deren, trataro, filede, nerada
            </p>
          ...
          <div class="col-lg-4 menu-item">
            <a href="{{url('front/assets/img/menu/menu-item-3.png')}}" class="glightbox"><img src="{{url('front/assets/img/menu/menu-item-3.png')}}" class="menu-img img-fluid" alt=""></a>
            <h4>Est Eligendi</h4>
            <p class="ingredients">
              Lorem, deren, trataro, filede, nerada
            </p>
          ...
          <div class="col-lg-4 menu-item">
            <a href="{{url('front/assets/img/menu/menu-item-4.png')}}" class="glightbox"><img src="{{url('front/assets/img/menu/menu-item-4.png')}}" class="menu-img img-fluid" alt=""></a>
            <h4>Eos Luibusdam</h4>
            <p class="ingredients">
              Lorem, deren, trataro, filede, nerada
            </p>
          ...
          <div class="col-lg-4 menu-item">
            <a href="{{url('front/assets/img/menu/menu-item-5.png')}}" class="glightbox"><img src="{{url('front/assets/img/menu/menu-item-5.png')}}" class="menu-img img-fluid" alt=""></a>
            <h4>Eos Luibusdam</h4>
            <p class="ingredients">
              Lorem, deren, trataro, filede, nerada
            </p>
          ...
          <div class="col-lg-4 menu-item">
            <a href="{{url('front/assets/img/menu/menu-item-6.png')}}" class="glightbox"><img src="{{url('front/assets/img/menu/menu-item-6.png')}}" class="menu-img img-fluid" alt=""></a>
...
<section id="chefs" class="chefs section-bg">
  <div class="container" data-aos="fade-up">
    ...
    <div class="row gy-4">
        ...
        @if($checfdata)
      @foreach($checfdata as $key => $checf)
      <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
        <div class="chef-member">
          <div class="member-img">
            <img src="{{asset('uploads/'.$checf->image)}}" class="img-fluid" alt="">
            <div class="social">
          ...
          <h4>{{$checf->name}}</h4>
            <span>{{$checf->position}}</span>
            <p>{{$checf->description}}</p></div>
        </div>
...
<section id="book-a-table" class="book-a-table">
  <div class="container" data-aos="fade-up">
    ...
    <div class="row g-0">
      ...
      <div class="col-lg-4 reservation-img" style="background-image: url({{url('front/assets/img/reservation.jpg')}});" data-aos="zoom-out" data-aos-delay="200"></div>
...
<section id="contact" class="contact">
      ...
      <div class="row gy-3">
        <div class="col-lg-3 col-md-6 d-flex">
          ...
          <div class="col-lg-3 col-md-6 footer-links d-flex">
            ...
            <div>
              <h4>Reservations</h4>
              <p>
                <strong>Phone:</strong> {{$l->phone}}<br>
          ...
          <div class="col-lg-3 col-md-6 footer-links d-flex">
            ...
            <div>
              <h4>Opening Hours</h4>
              <p>
                <strong>{{$l->opening_time}}</strong><br>
        ...
        <div class="col-lg-3 col-md-6 footer-links">
          ...
          <div class="social-links d-flex">
            <a href="{{url('front/#')}}" class="twitter"><i class="bi bi-twitter"></i></a>
            <a href="{{url('front/#')}}" class="facebook"><i class="bi bi-facebook"></i></a>
            <a href="{{url('front/#')}}" class="instagram"><i class="bi bi-instagram"></i></a>
            <a href="{{url('front/#')}}" class="linkedin"><i class="bi bi-linkedin"></i></a>
          </div>
        </div>
  ...
  <a href="{{url('front/#')}}" class="scroll-top d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>
